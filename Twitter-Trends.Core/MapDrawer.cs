...
namespace Twitter_Trends
{
        ...
        private static readonly List<(double Value, Color Color)> ColorStops = new List<(double, Color)>
    {
        ...
        public static async Task AddTweetPointsToMap(List<Tweet> tweets, Map map)
        {
            var features = new List<GeometryFeature>();
            ...
            foreach (var tweet in tweets)
            {
                ...
                var tweetLocation = DataAnalyzer.ReverseCoordinates(tweet.Location);
                var feature = new GeometryFeature
                {
                    Geometry = tweetLocation
                };
            ...
            var tweetLayer = new Layer("Tweets")
            {
                DataSource = new MemoryProvider(features),
                Style = null
            };
